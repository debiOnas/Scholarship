	  ...
	  <div class="container">
       ...
       <div class="main">
             ...
             <form method="post" action="contact-post.html">
				...
				<input type="text" class="textbox" name="txtEmail" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}">
				<input type="text" class="textbox" name="txtPassword" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">			 
				<input type="text" class="textbox" name="txtUlangi Password" value="Ulangi Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Ulangi Password';}">
